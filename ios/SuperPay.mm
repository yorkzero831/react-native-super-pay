...
RCT_EXPORT_METHOD(alipay:(NSString *)info callback:(RCTResponseSenderBlock)callback)
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
      ...
      [[AlipaySDK defaultService] payOrder:info fromScheme:self->alipayScheme callback:^(NSDictionary *resultDic) {
...
{
    return std::make_shared<facebook::react::NativeSuperPaySpecJSI>(params);
}
#endif
